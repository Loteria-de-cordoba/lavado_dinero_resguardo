...
function regresa_a_tu_pagina_ya()
{ 	
		if(isset($_GET['_pagi_pg']) and !isset($_GET['pagiactual']))
			{		
					$pagiac= $_GET['_pagi_pg'];
			}
			else
			{
				if(isset($_GET['pagiactual']))
				{
					$pagiac= $_GET['pagiactual'];
					unset($_GET['pagiactual']); 
				}
				else
				{
					//echo "paso";
