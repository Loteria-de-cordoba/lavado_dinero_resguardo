...
if (isset($_POST['mes_desde_pep'])) {
	$mes_desde_pep = $_POST['mes_desde_pep'];
	} 
	else {
		$mes_desde_pep= 1;
	}
if (isset($_POST['mes_hasta_pep'])) {
	$mes_hasta_pep = $_POST['mes_hasta_pep'];
	} 
	else {
		$mes_hasta_pep=1;
	}

if (isset($_POST['ano_desde_pep'])) {
	$ano_desde_pep = $_POST['ano_desde_pep'];
	} 
	else {
		$ano_desde_pep=2015;
	}

if (isset($_POST['ano_hasta_pep'])) {
	$ano_hasta_pep = $_POST['ano_hasta_pep'];
	} 
	else {
		$ano_hasta_pep=2015;
	}
	
if (isset($_POST['mayores_pep'])) {
	$mayores_pep = $_POST['mayores_pep'];
	$mayores_pep =1;
...
if (isset($_POST['juego_pep'])) {
	$juego_pep = $_POST['juego_pep'];
	} 
	else {
		$juego_pep='Todos';
	}
...
$fecha_desde='01'.'/'.str_pad($mes_desde,2,'0',STR_PAD_LEFT).'/'.$ano_desde;

//pep
$fechapep='15/'.$mes_hasta_pep.'/'.$ano_hasta_pep;

//echo 'fecha'.$juego;
//$db->debug=true;
try {
	$rs_dias_del_mes_pep = $db->Execute("SELECT TO_CHAR(LAST_DAY(to_date('$fechapep','dd/mm/yyyy')),'DD') dias FROM DUAL ");
	}
	catch  (exception $e) 
...
$row_pep = $rs_dias_del_mes_pep->FetchNextObject($toupper=true);	
$dias_pep=$row_pep->DIAS;	
$fecha_desde_pep='01'.'/'.str_pad($mes_desde_pep,2,'0',STR_PAD_LEFT).'/'.$ano_desde_pep;
...
*/	
$fecha_hasta=$dias.'/'.str_pad($mes_hasta,2,'0',STR_PAD_LEFT).'/'.$ano_hasta;

//pep
$fecha_hasta_pep=$dias_pep.'/'.str_pad($mes_hasta_pep,2,'0',STR_PAD_LEFT).'/'.$ano_hasta_pep;
//echo $fecha_hasta_pep;
...
/*$_SESSION['sql_consolidacion']="select gdor.id_ganador, mo.descripcion as moneda, gdor.valor_premio, gdor.concepto ,jue.juegos, gdor.domicilio_pago, gdor.fecha_alta,
								...
								from PLA_AUDITORIA.t_ganador gdor, PLA_AUDITORIA.t_moneda mo, juegos.juegos jue, PLA_AUDITORIA.t_tipo_pago pago, 
									PLA_AUDITORIA.t_info_direcciones info, PLA_AUDITORIA.t_tipo_documento td, utilidades.t_localidades lo, utilidades.t_provincias pro, 
...
<table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="100"><table border="0" cellspacing="0">
        ...
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['ano']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['ano']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['ano']==2012) echo 'selected=selected;'?>>2012</option>
 ...
 <table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="101"><table width="101" border="0" cellspacing="0">
        ...
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['anog']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['anog']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['anog']==2012) echo 'selected=selected;'?>>2012</option>
  ...
  <tr>
    <td width="561">
      ...
      <td><select name="ano_desde" size="1" id="ano_desde" onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;">
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['ano_desde']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['ano_desde']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['ano_desde']==2012) echo 'selected=selected;'?>>2012</option>
      ...
      <select name="ano_hasta" size="1" id="ano_hasta" onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;">
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['ano_hasta']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['ano_hasta']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['ano_hasta']==2012) echo 'selected=selected;'?>>2012</option>
...
<p>&nbsp;</p>
 <table width="741" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4" align="center" class="textoAzulOscuro">Generar Excel PEP's Hist&oacute;rico</td>
  </tr>
  <tr>
    <td width="561">
    	<table width="561" border="0" cellspacing="0">
      ...
      <tr>
      <td>
      <select name="mes_desde_pep" id="mes_desde_pep"  onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;" >
        <option value="1" <?php    if ($_POST['mes_desde_pep']==1) echo 'selected=selected;'?> >enero</option>
        <option value="2"  <?php   if ($_POST['mes_desde_pep']==2) echo 'selected=selected;'?> >febrero</option>
        <option value="3" <?php    if ($_POST['mes_desde_pep']==3) echo 'selected=selected;'?> >marzo</option>
        <option value="4"  <?php   if ($_POST['mes_desde_pep']==4) echo 'selected=selected;'?> >abril</option>
        <option value="5"  <?php   if ($_POST['mes_desde_pep']==5) echo 'selected=selected;'?> >mayo</option>
        <option value="6"  <?php   if ($_POST['mes_desde_pep']==6) echo 'selected=selected;'?> >junio</option>
        <option value="7"  <?php   if ($_POST['mes_desde_pep']==7) echo 'selected=selected;'?> >julio</option>
        <option value="8"  <?php   if ($_POST['mes_desde_pep']==8) echo 'selected=selected;'?> >agosto</option>
        <option value="9"  <?php   if ($_POST['mes_desde_pep']==9) echo 'selected=selected;'?> >setiembre</option>
        <option value="10"  <?php   if ($_POST['mes_desde_pep']==10) echo 'selected=selected;'?> >octubre</option>
        <option value="11"  <?php   if ($_POST['mes_desde_pep']==11) echo 'selected=selected;'?> >noviembre</option>
        <option value="12"  <?php   if ($_POST['mes_desde_pep']==12) echo 'selected=selected;'?> >diciembre</option>
      </select>
      </td>
      
      <td><select name="ano_desde_pep" size="1" id="ano_desde_pep" onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;">
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['ano_desde_pep']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['ano_desde_pep']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['ano_desde_pep']==2012) echo 'selected=selected;'?>>2012</option>
        <option value="2011" <?php   if ($_POST['ano_desde_pep']==2011) echo 'selected=selected;'?>>2011</option>
        <option value="2010" <?php   if ($_POST['ano_desde_pep']==2010) echo 'selected=selected;'?>>2010</option>
      </select></td>
      
      <td><select name="mes_hasta_pep" id="mes_hasta_pep"  onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;" >
        <option value="1" <?php    if ($_POST['mes_hasta_pep']==1) echo 'selected=selected;'?> >enero</option>
        <option value="2"  <?php   if ($_POST['mes_hasta_pep']==2) echo 'selected=selected;'?> >febrero</option>
        <option value="3" <?php    if ($_POST['mes_hasta_pep']==3) echo 'selected=selected;'?> >marzo</option>
        <option value="4"  <?php   if ($_POST['mes_hasta_pep']==4) echo 'selected=selected;'?> >abril</option>
        <option value="5"  <?php   if ($_POST['mes_hasta_pep']==5) echo 'selected=selected;'?> >mayo</option>
        <option value="6"  <?php   if ($_POST['mes_hasta_pep']==6) echo 'selected=selected;'?> >junio</option>
        <option value="7"  <?php   if ($_POST['mes_hasta_pep']==7) echo 'selected=selected;'?> >julio</option>
        <option value="8"  <?php   if ($_POST['mes_hasta_pep']==8) echo 'selected=selected;'?> >agosto</option>
        <option value="9"  <?php   if ($_POST['mes_hasta_pep']==9) echo 'selected=selected;'?> >setiembre</option>
        <option value="10"  <?php   if ($_POST['mes_hasta_pep']==10) echo 'selected=selected;'?> >octubre</option>
        <option value="11"  <?php   if ($_POST['mes_hasta_pep']==11) echo 'selected=selected;'?> >noviembre</option>
        <option value="12"  <?php   if ($_POST['mes_hasta_pep']==12) echo 'selected=selected;'?> >diciembre</option>
      </select>      </td>
      
      <td>
      <select name="ano_hasta_pep" size="1" id="ano_hasta_pep" onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;">
        <option value="2015" <?php   if ($_POST['ano']==2015) echo 'selected=selected;'?>>2015</option>
        <option value="2014" <?php   if ($_POST['ano_hasta_pep']==2014) echo 'selected=selected;'?>>2014</option>
        <option value="2013" <?php   if ($_POST['ano_hasta_pep']==2013) echo 'selected=selected;'?>>2013</option>
        <option value="2012" <?php   if ($_POST['ano_hasta_pep']==2012) echo 'selected=selected;'?>>2012</option>
        <option value="2011" <?php   if ($_POST['ano_hasta_pep']==2011) echo 'selected=selected;'?>>2011</option>
        <option value="2010" <?php   if ($_POST['ano_hasta_pep']==2010) echo 'selected=selected;'?>>2010</option>
      ...
      <td align="center">
      	<input name="mayores_pep" id="mayores_pep" type="checkbox" onclick="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;" <?php if($mayores_pep==1){ $checked='checked=checked';} else { $checked='';}?> <?php echo $checked ?>/>
      
      </td>
      
      <td>
      	<select name="juego_pep" size="1" id="juego_pep" onchange="ajax_post('contenido','premio/elegir_mes.php',document.FrmBuscaFechaConformar);return false;">
        <option value="Todos" <?php   if ($_POST['juego_pep']=='Todos') echo 'selected=selected;'?>>Todos</option>
        <option value="Casino" <?php   if ($_POST['juego_pep']=='Casino') echo 'selected=selected;'?>>Casino</option>
        <option value="Otros Juegos" <?php   if ($_POST['juego_pep']=='Otros Juegos') echo 'selected=selected;'?>>Otros Juegos</option>
    ...
    <td width="180" valign="bottom"><a href="list/listado_peps_xls.php?fecha_desde=<?php echo $fecha_desde_pep; ?>&fecha_hasta=<?php echo $fecha_hasta_pep; ?>&mayores=<?php echo $mayores_pep; ?>&juego=<?php echo $juego_pep; ?>" target="_blank">
    <img src="image/Microsoft Office Excel.gif" width="25" height="25" border="0" /></a>
     <a href="list/listado_peps_xls.php?fecha_desde=<?php echo $fecha_desde_pep; ?>&fecha_hasta=<?php echo $fecha_hasta_pep; ?>&mayores=<?php echo $mayores_pep; ?>&juego=<?php echo $juego_pep; ?>" target="_blank" class="label">Generar Excel</a></td>
     </tr>
</table>
