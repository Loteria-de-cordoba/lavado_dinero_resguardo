...
try {
	$rs_consulta = $db->Execute("select g.id_ganador,to_char(g.fecha_nacimiento,'dd/mm/yyyy')fecha_nacimiento,g.lugar_nacimiento,g.sexo, g.id_tipo_documento, 
                					...
                					td.descripcion, lo.n_localidad, pro.n_provincia, pa.n_pais, pa.id_pais, pro.id_provincia, g.conformado, G.DDJJ
...
<link href="../estilo/estilo.css" rel="stylesheet" type="text/css" />    
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="validar_modificar_ganador('contenido','premio/procesar_modificar_premio2.php',this); return false;">
    ...
    <tr>
    	<td align="left" class="texto6" scope="row">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td class="td_detalle"><?php echo armar_combo($rs_tipo_documento,'id_tipo_documento',utf8_decode($row->ID_TIPO_DOCUMENTO)); ?></td>
            ...
            <tr align="left">
              ...
              <td colspan="6" align="right" class="texto5" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="64%" class="smallRojo" align="left"> <input name="profesion" type="text" class="small" id="profesion" size="30" maxlength="50" value="<?php echo utf8_encode($row->PROFESION); ?>" />
...
<input name="dpto" type="text" class="small" id="dpto" size="3" value="<?php echo $row->DPTO ?>"/>
            ...
            <td align="right" class="smallVerde" scope="row">DDJJ Nro:</td>
              <td colspan="9" scope="row" class="smallVerde"><input name="ddjj" class="small" type="text"  id="ddjj" size="3" maxlength="4" value="<?php echo $row->DDJJ ?>" />Estado civil
                      ...
                      <tr>
                        ...
                        <tr align="left">
                            ...
                            <tr>
                              ...
                              <td align="left" class="smallVerde" scope="row"><?php  abrir_calendario('fecha_pago','premio', $row->FECHA_ALTA);?></td>
                              <td align="left" class="smallVerde" scope="row">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td width="100" class="td_detalle"><input name="valor_premio" class="small" type="text" id="valor_premio" size="14" maxlength="14" value="<?php echo $row->VALOR_PREMIO; ?>" /></td>
                              <td width="379" class="smallVerde">Numero de Ticket/Cupon/Billete
                                <input name="nro_ticket" class="small" type="text"  id="nro_ticket" size="14" maxlength="14" value="<?php echo $row->NRO_TICKET; ?>"/>                               </td>
                            ...
                            <tr valign="top">
                              ...
                              <td colspan="5" class="smallRojo"><?php echo armar_combo($rs_moneda,'id_moneda',$row->ID_MONEDA); ?>Moneda en la cual se paga el premio</td>
                            </tr>
                            <tr>
                              <td align="right" class="smallVerde" scope="row">Concepto</td>
                              <td align="right" class="texto5" scope="row">&nbsp;</td>
                              <td colspan="3" valign="middle" class="smallRojo"><label>
                                <textarea name="concepto" id="concepto" cols="50" rows="3" class="small" ><?php echo $row->CONCEPTO; ?></textarea>
                              ...
                              <td width="205" class="td_detalle"><table width="93%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                              ...
                                              <td width="124" class="td_detalle"><?php echo armar_combo($rs_juego,'juego',$row->JUEGO); ?>                              </td>
                                </tr>
                                <tr>
                                  <td width="75" align="right" class="smallVerde">Sorteo Nro</td>
                                  <td width="124" align="left" class="texto5"><input name="sorteo_nro" id="sorteo_nro" class="small" size="15" value="<?php echo $row->SORTEO_NRO; ?>"/></td>
                                </tr>
                              </table></td>
                          </tr>
                            ...
                            <tr>
                              ...
                              <td align="right" class="texto5" scope="row">&nbsp;</td>
                              <td colspan="5" class="td_detalle"><?php echo armar_combo($rs_tipo_pago,'id_tipo_pago',$row->ID_TIPO_PAGO); ?></td>
                          </tr>
                            <tr>
                              <td align="right" class="smallVerde" scope="row">Domicilio</td>
                              <td align="right" class="texto5" scope="row">&nbsp;</td>
                              <td colspan="5" class="smallRojo"><input name="domicilio_pago" readonly="readonly" type="text" class="small" id="domicilio_pago" size="70" maxlength="70" value="<?php echo $row->DOMICILIO_PAGO; ?>" /> Domicilio donde se adjudico el premio</td>
                          </tr>
                            <tr align="left">
                              ...
                              <td colspan="5" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr valign="top">
                                    <td height="52" scope="col"><input name="cuenta_bancaria" type="text" readonly="readonly" class="small" id="cuenta_bancaria" size="40" maxlength="50" value="<?php echo $row->CUENTA_BANCARIA_SALIDA; ?>"/></td>
                            ...
                            <tr align="left">
                              <td align="right" valign="top" class="smallVerde" scope="row">Cheque Nro</td>
                              <td align="right" class="texto5" scope="row">&nbsp;</td>
                              <td colspan="5" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td class="smallRojo"><input name="cheque_nro" type="text" class="small" id="cheque_nro" size="20" value="<?php echo $row->CHEQUE_NRO; ?>"/>Nro de Cheque (en caso de corresponder).</td>
                                </tr>
                              </table></td>
                            </tr>
                        </table></td>
            ...
            <tr>
              ...
              <tr>
              <td align="right" class="smallVerde" scope="row">Apellido</td>
              <td colspan="5" class="td_detalle"><input name="apellido2" type="text" class="small" id="apellido2" size="50" maxlength="50" value="<?php echo $row->APELLIDO2 ?>"/></td>
            </tr>
            <tr align="left">
              <td align="right" class="smallVerde" scope="row">Nombre</td>
              <td scope="row"><input name="nombre2" type="text" class="small" id="nombre2" size="50" maxlength="50" value="<?php echo $row->NOMBRE2 ?>" /></td>
              <td colspan="3" align="left" class="smallVerde">&nbsp;</td>
              <td width="214" scope="row">&nbsp;</td>
            ...
            <tr align="left">
              ...
              <input type="hidden" name="mayores" id="mayores" value="<?php echo $_GET['mayores']; ?>" />
               <?php } ?>
               
                <?php 
			

				if (($row->CONFORMADO==1)and($_SESSION['rol'.$i]=='ROL_LAVADO_DINERO_ADMINISTRA')) {?>
              <input name="button" type="submit" class="textoAzulOscuro" id="button" value="Guardar" />
              <input type="hidden" name="id_ganador" id="id_ganador" value="<?php echo $row->ID_GANADOR; ?>" />
              <input type="hidden" name="fdesde" id="fdesde" value="<?php echo $_GET['fdesde']; ?>" />
              <input type="hidden" name="fhasta" id="fhasta" value="<?php echo $_GET['fhasta']; ?>" />
