...
<img src="image/xmag.gif" alt="Buscar" width="22" height="18" border="0" /></span><span class="texto4Totales"></span></td>
            ...
            <tr>
              ...
              <td align="right" class="texto5" scope="row">&nbsp;</td>
              <td colspan="5" class="td_detalle"><input name="apellido" type="text" class="small" id="apellido" size="50" maxlength="50" value="<?php echo utf8_encode($row->APELLIDO); ?>" /></td>
            </tr>
            <tr align="left">
              <td align="right" class="texto5" scope="row">Nombre</td>
              <td align="right" class="texto5" scope="row">&nbsp;</td>
              <td colspan="5" scope="row"><span class="td_detalle">
                <input name="nombre" type="text" class="small" id="nombre" size="50" maxlength="50" value="<?php echo utf8_encode($row->NOMBRE); ?>" />
              </span></td>
            </tr>
            <tr align="left">
                            ...
                            <tr>
                              <td scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td align="right" class="texto5" scope="row">&nbsp;</td>
                                    <td colspan="2" class="td_detalle"><input name="domicilio_pago" type="text" class="small" id="domicilio_pago" size="70" maxlength="70" value="<?php echo utf8_encode($row1->DIRECCION); ?>" /></td>
                                    ...
                                    <td colspan="5" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr valign="top">
                                          <th height="52" scope="col"><span class="td_detalle">
                                            <input name="cuenta_bancaria" type="text" class="small" id="cuenta_bancaria" size="50" maxlength="50" value="<?php echo utf8_encode($row1->CUENTA_BANCARIA) ?>" />
                                          </span></th>
