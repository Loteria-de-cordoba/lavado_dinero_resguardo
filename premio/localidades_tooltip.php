...
<table border="0"   cellpadding="0" cellspacing="0">
 <tr>
  ...
  <form name="localidad" method="post" action="#" onSubmit="ajax_post_tooltip('contenido_tooltip','premio/localidades_tooltip.php',this); return false;">
		  ...
		  <table  width="100%" border="0" cellspacing="0">
              ...
              <?php while ($row = $_pagi_result->FetchNextObject($toupper=true)) { ?>
               <tr class="smallCalendario">
                 <td class="texto3Totales"><a href="#" onClick="document.<?php echo $formulario;?>.localidad.value='<?php echo utf8_encode($row->N_LOCALIDAD);?>';
                                                                document.<?php echo $formulario;?>.cod_localidad.value='<?php echo $row->ID_LOCALIDAD; ?>'; 
                                                                document.<?php echo $formulario;?>.localidad_memo.value='<?php echo utf8_encode($row->N_LOCALIDAD);?>';
                                                                document.<?php echo $formulario;?>.cod_localidad_memo.value='<?php echo $row->ID_LOCALIDAD; ?>';
