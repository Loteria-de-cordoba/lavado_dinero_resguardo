    	...
    	<td align="left" class="texto6" scope="row">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td colspan="5" align="left" class="td_detalle"><span class="smallVerde">Nro. Documento</span><span class="smallRojo">
                <input name="documento" type="text" id="documento" class="small" size="13" maxlength="13" value="<?php echo $_POST['documento'] ?>"   />
...
<input name="dpto" type="text" class="small" id="dpto" size="3"/></td>
            ...
            <tr align="left">
              ...
              <td scope="row"><input name="estado_civil" class="small" type="text"  id="estado_civil" size="20" maxlength="20" /></td>
              <td align="right" ><span class="smallVerde">Telefono</span></td>
              <td width="10%" align="right" class="smallVerde" scope="row"><input name="telefono" class="small" type="text" id="telefono" size="20" maxlength="20" /></td>
              <td colspan="3" align="left" scope="row" class="smallVerde">
                Email
                <input name="email" class="small" type="text" id="email" size="50" maxlength="50"/></td>
              </tr>
            ...
            <tr>
              ...
              <td colspan="3" class="td_detalle"><span class="smallRojo">
                <input name="documento2" type="text" id="documento2" class="small" size="13" maxlength="13" value="<?php echo $_POST['documento2'] ?>"   />
                    Identificacion del cliente (Tipo de documento y numero)</span></td>
              </tr>
            <tr>
                        <td align="right" class="smallVerde" scope="row">CUIT/CUIL</td>
                        <td colspan="5" class="smallRojo"><input name="cuit2" type="text" class="small" id="cuit2" size="13" maxlength="13" />
                          Sin punto ni guion<span class="smallRojo">
                            <label><a href="#" class="smallRojo"  onclick="window.open ('http://servicioswww.anses.gov.ar/ConstanciadeCuil2/Inicio.aspx','anses')";><strong>verificar cuit</strong></a></label>
                            </span>
                          <label> </label>
