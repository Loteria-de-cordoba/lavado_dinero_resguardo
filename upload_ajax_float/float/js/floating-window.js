...
************************************************************************************************************/
	...
	*/	
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = 'upload_ajax/float/images/top_left.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = 'upload_ajax/float/images/top_center.gif';
		...
		var img = document.createElement('IMG');
		img.src = 'upload_ajax/float/images/minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = 'upload_ajax/float/images/close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = 'upload_ajax/float/images/top_right.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = 'upload_ajax/float/images/bottom_right.gif';
	...
	function addContentFromUrl(url,windowId)
	{
		...
		ajaxObjects[ajaxIndex] = new sack_upload();
		...
		ajaxObjects[ajaxIndex].runAJAX_upload();		// Execute AJAX function			
