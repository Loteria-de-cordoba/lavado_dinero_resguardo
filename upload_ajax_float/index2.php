...
*/ 
?>
<form  target="hiddenframe" enctype="multipart/form-data" action="upload_ajax/upload.php" method="POST" name="uploadform">
  <p>Adjuntar Documentacion al servidor:<br />
    <input name="filefieldname" type="file" id="fileField"   onchange="document.uploadform.submit()" size="60"/>
  </p>
  <p id="uploadedfile" >
  <?php 
