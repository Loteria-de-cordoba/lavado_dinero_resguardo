...
//$pdf->SetX(30);
$pdf->Cell(190,8,'Listado de Clientes Informados Eliminados - '.$dias,0,1,'C',1);
...
$pdf->Ln(5);
	...
	$pdf->Cell(51,6,'Novedad de Eliminacion',1,1,'C');
...
$pdf->Ln(5);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(190,8,'Total de Clientes Informados Eliminados  ==============>     '.$toto,0,1,'C',1);
$pdf->setx(40);
}
else
{
