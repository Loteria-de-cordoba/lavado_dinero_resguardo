...
$pdf->SetFillColor(240,240,240);
	...
	if($_REQUEST['id_estado']==0)
		{
			$pdf->Cell(190,8,'MATRIZ de RIESGO -  ALERTAS PROCESADAS EN PERIODOS ANTERIORES',0,1,'C',1);
		}
	else
		{
			$pdf->Cell(190,8,'MATRIZ de RIESGO -  ALERTAS PROCESADAS EN EL PERIODO '.$_REQUEST['id_estado'],0,1,'C',1);
		}
	$pdf->Ln(12);
	$pdf->SetX(10);
