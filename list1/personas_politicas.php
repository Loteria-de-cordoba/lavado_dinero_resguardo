...
$titulo='Listado de Ganadores entre el '.$fecha .'y '.$fhasta;
//$db->debug=true;
try{
	
	 $rs = $db->Execute("	select to_char(a.fecha_alta,'DD/MM/YYYY') as fecha,a.apellido, a.nombre, a.politico, a.ddjj, b.nombre sucursal
