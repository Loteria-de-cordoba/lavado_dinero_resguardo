...
<tr>
	<td colspan="10" align="center">
		...
		<h3><Strong>Detalle del calculo de las retenciones del impuesto a las ganancias de</Strong></h3>
		<h2><Strong>Leg <?php echo $row->LEGAJO .' '. $row->DESC_EMPLEADO; ?> </Strong></h2>
		</div>  
	</td>
</tr>
</table>
...
<form  name="form1" method="post" action="#" onsubmit="ajax_post('contenido','calculo/informe_impuesto_ganancias_detalle.php',this); return false;">
<table width="70%"  border="0" align="center" style="margin-bottom:15px;">
    <tr>
		...
		<td width="45%" align="right" valign="middle">
			<a href="#" onClick="ajax_get('contenido','calculo/informe_impuesto_ganancias.php','planta=<?php echo $row->ID_PLANTA; ?>&legajo=<?php echo $row->LEGAJO; ?>&periodo=<?php echo $periodo; ?>&mes=<?php echo $mes; ?>'); return false;" style="text-decoration:none;">Volver<img width="16" height="16" border="0" title="Volver" src="image/undo.png" style="margin-left:5px;"></a>
		</td>
...
<table width=70% border="0" align="center" cellspacing="1" style="margin-bottom:50px;">
    ...
    <?php if($row->APLICA=='N')
		{?>
        	<td width="88%" align="left" class="thpadding_titulo">Aplica</td><td align="right" ><input type="checkbox" name="aplica[]" id="aplica_<?php echo $row->ID_EMPLEADO; ?>" <?php if($row->APLICA=='S'){echo ' checked="checked"';} ?> value="<?php echo $row->ID_EMPLEADO;?>"><input name="guardar" class="smallTahoma" id="guardar" value="Ejecutar" type="submit" style="margin-left:5px;"/>
         <?PHP
		}
		else
		{
		?>
        	<td width="88%" align="left" class="thpadding_titulo">Aplica</td><td align="right" ><input type="checkbox" name="aplica[]" id="aplica_<?php echo $row->ID_EMPLEADO; ?>" value="<?php echo $row->ID_EMPLEADO;?>" disabled="disabled"><input name="guardar" class="smallTahoma" id="guardar" value="Ejecutar" type="submit" style="margin-left:5px;" disabled="disabled"/>  <?php
		}?>
	...
	<tr class="th5">
        <td width="88%" align="left" class="thpadding">Ganancias neta</td><td align="right" ><?php echo $row->GAN_NETA;?></td>
    </tr>
	...
	<tr class="th2 thpadding_titulo">
        <td width="88%" align="left" class="thpadding_titulo">RETENCIONES A PRACTICAR O INGRESAR</td><td align="right" ><?php echo $row->RETENCION_ACTUAL;?></td>
    </tr>
</table>
</form>
