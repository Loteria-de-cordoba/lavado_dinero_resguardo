...
$titulo = 'Movimientos de Casino Caja Publica - [Datos de Sistema Foraneo]';
...
try{
	$res = $db->Execute("SELECT DECODE(anulado,'S', 'ANULADO', '') AS ANULADO, casa, caja, moneda,
								to_char(fecha,'dd/mm/yyyy') || decode(hora,NULL,'',' ' || hora) as fecha, nombre, importe_ficha, cod_mov_caja,
								TO_CHAR(fecha,'dd/mm/yyyy') AS dia,
									  DECODE(hora,NULL,'',' '
									  || hora) AS hora,
									  DECODE(DECLARACION_JURADA,NULL,'0',DECLARACION_JURADA) AS JURADA
