...
-->
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="ajax_post('contenido','denegado/procesar_modificar_informado.php',this); return false;">
...
<tr>
                    ...
                    <td align="center"  colspan="2"  style="background-color:#999966"> MODIFICACION DE CLIENTES A INFORMAR</td>
    </tr>
      <!--<tr>
