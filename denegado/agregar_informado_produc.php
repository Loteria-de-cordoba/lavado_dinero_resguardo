...
<td width="16%">
      <div align="right"><img src="image/24px-Crystal_Clear_action_reload.png" alt="Regresar" width="16" height="16" border="0" align="absbottom" /><a href="#"  onclick="ajax_get('contenido','denegado/adm_informado.php','fecha=<?php echo $fecha ?>')">Regresar</a></div></td>
</tr>
</table>
...
<tr>
                    ...
                    <td align="center"  colspan="2"  style="background-color:#999966"> ALTA DE CLIENTES A INFORMAR</td>
    </tr>
     <!--<tr>
    ...
    <tr>
      <td width="349"   scope="col" style="background-color:#999966">Nro. Documento:</td>
      <td width="331"><input type="text" name="docu" id="docu" onblur="if(this.value.length!=8) {var alerta='Solo ocho digitos '; alert(alerta);this.value='';return false;}" style="text-align:center;" value="<?php echo $docu;?>"/></td>
    </tr>
    <!--<tr >
