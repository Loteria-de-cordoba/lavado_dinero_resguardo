...
$_pagi_sql ="SELECT b.id_informado idid,
				...
				us.descripcion as usuario,
				  ...
				  decode(b.novedad_FINAL,null,'Sin Novedad',b.novedad_FINAL) novedad				  	 
				...
				order by 2";
$_pagi_div = "contenido";
$_pagi_enlace = "denegado/adm_informado_eliminado.php";
...
<tr>
  <td><form id="novedad" name="novedad" action="#" onsubmit="ajax_post('contenido','denegado/adm_informado_eliminado.php',this); return false;">
      <table width="89%"  align="center">
        <tr>
          <td colspan="13" align="center" valign="bottom" class="texto4" scope="col">Administraci&oacute;n de Clientes Informados Eliminados</td>
        </tr>
        <tr>
          <td colspan="3" align="left" class="td8">Fecha Contable:<?php echo $fecha;?></td>
          <td colspan="10" class="td8"><div align="right"><img src="image/24px-Crystal_Clear_action_reload.png" alt="Regresar" width="16" height="16" border="0" align="absbottom" /><a href="#"  onclick="ajax_get('contenido','denegado/adm_informado.php','fecha=<?php echo $fecha ?>&idid=<?php echo $id_id ?>&fhasta=<?php echo $fhasta ?>')">Regresar</a></div></td>
        </tr>
        ...
        <tr>
          <td colspan="10" align="center" valign="bottom" class="smallRojo" scope="col"><div id="abredia">&nbsp;</div></td>
        </tr>
      </table>
    </form>
    <div id="elimina">&nbsp;</div>
    <?php if ($_pagi_result->RowCount()==0) {
		...
		die("<br><div align=\"center\"><span class=\"textoRojo\">NO EXISTEN CLIENTES INFORMADOS YA ELIMINADOS</span> <a href=\"#\" class=\"Estilo3\" onclick=\"ajax_get('contenido','blanco.php','')\">Cerrar</a></div>");
}
?>
    <span class="td4">
    <?php }?>
    ...
    <table width="83%" border="0" align="center">
      ...
      <tr align="center" class="td2">
        ...
        <td width="26%"   class="td4" scope="col">Novedad de Eliminaci&oacute;n / Recuperaci&oacute;n</td>
...
//FinalizarTransaccion($db);	   
	   ?>">
        ...
        <a id="down_<?php echo $row->IDID; ?>" href="#" onClick="ampliarImagen(); ver_historico_2('div2_<?php echo $row->IDID;?>','denegado/recuperar_informado.php','id_id=<?php echo $row->IDID;?>','<?php echo $row->IDID; ?>'); return false;" title="" ><img src="image/recuperar.jpg" title="Recuperacion de Informado" width="40" height="40" border="0"/></a></td>
        <!--<td width="6%" align="center">
