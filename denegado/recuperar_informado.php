...
<form id="modi<?php echo $id_id;?>" name="modi<?php echo $id_id;?>" action="#" onsubmit="ajax_post('contenido','denegado/procesar_recuperar_informado.php',this); return false;">
  <table width="85%" height="53"  border="2" align="center">
    <tr>
      <td align="center"  colspan="4"  class="texto4_info">RECUPERACION DE CLIENTES INFORMADOS ELIMINADOS</td>
    </tr>
    <tr>
      <td width="189" class="td2_info"     scope="col">Apellido y Nombre:</td>
      <td width="270"><input type="text" disabled="disabled" name="apenom<?php echo $id_id;?>" id="apenom<?php echo $id_id;?>" style="width:220; font-size:9px; font-weight:500" value="<?PHP echo $apenom;?>" /></td>
      <td width="299"    scope="col" class="td2_info">Novedad de Eliminac./Recuper.:</td>
      <td width="331"><textarea name="novedad<?php echo $id_id;?>" class="small_info"  id="novedad<?php echo $id_id;?>"  rows="1" cols="42"/><?php echo $novedad;?></textarea></td>
    </tr>
    <tr>
      <td colspan="4" align="center" style="text-align:center; background-color:#CCCCCC"><div style="text-align:center;margin-top:5px;margin-bottom:5px;">
        ...
        <input name="idid" id="idid" type="hidden" value="<?php echo $id_id;?>"/>
         <input name="fhasta" id="fhasta" type="hidden" value="<?php echo $fhasta;?>"/>
        <input name="buttonx" class="small_infoTahoma" id="buttonx" style="font-size:11px;color:#333333;font:bold" value="Recuperar" type="button" onClick="ajax_get('contenido','denegado/procesar_recuperar_informado.php','id_id=<?php echo $id_id;?>&fecha=<?php echo $fecha;?>&fhasta=<?php echo $fhasta;?>&novedad='+modi<?php echo $id_id;?>.novedad<?php echo $id_id;?>.value+'&apenom='+modi<?php echo $id_id;?>.apenom<?php echo $id_id;?>.value); return false;"></td>
