...
<tr>
	<td colspan="9" align="center" valign="bottom" class="texto4" scope="col">Anula esta Cedula</a></td>
</tr>
  <tr valign="bottom" class="td8" >
      ...
      <td width="50%" align="center" valign="middle" class="td2"  scope="col"><input name="acepta" type="button" value="Aceptar" onClick="ajax_get('contenido','denegado/eliminar_denegado.php','idid=<?php echo $idid;?>&fecha=<?php echo $fecha;?>'); return false;"></td>      
