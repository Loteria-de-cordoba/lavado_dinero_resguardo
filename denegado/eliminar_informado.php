...
-->
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="ajax_post('contenido','denegado/informado_eliminar_grabar.php',this); return false;">
...
<td width="16%">
      <div align="right"><img src="image/24px-Crystal_Clear_action_reload.png" alt="Regresar" width="16" height="16" border="0" align="absbottom" /><a href="#"  onclick="ajax_get('contenido','denegado/adm_informado.php','fecha=<?php echo $fecha ?>&idid=<?php echo $id_id ?>')">Regresar</a></div></td>
</tr>
</table>
...
<table width="62%" height="53"  border="2" align="center">
	...
	<tr>
        ...
        <td align="center"  colspan="2"  style="background-color:#999966">ELIMINACION DEFINITIVA DE INFORMADO U.I.F.</td>
    </tr>
