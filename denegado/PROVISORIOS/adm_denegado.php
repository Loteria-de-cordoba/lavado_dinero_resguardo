...
if (isset($_REQUEST['fecha_vto'])&& $_REQUEST['fecha_vto']<>'' ) {
			...
			if($fecha_vto=='02/02/0002')
				...
				else
				{
					...
					{
						$condicion_fechavto="and ADD_MONTHS(b.fecha_cedula-1,6) = to_date('$fecha_vto','dd/mm/yyyy')
											and vto='S'";
					}
					else
					{
...
{
//EJERZO AUDITORIA
	 $describa='Siendo las '.$serhora.' horas,  El Agente '.$auditado.' consulta Cedulas U.I.F.';
...
try {
			$rs_principal = $db ->Execute("SELECT b.id_denegado idid,
				...
				us.descripcion as usuario,
				  ...
				  DECODE(B.FECHA_CEDULA,NULL,'',DECODE(VTO,'S',to_char(ADD_MONTHS(b.fecha_cedula -1,6),'dd/mm/yyyy'),'')) FECHAVTO		  	 
				FROM lavado_dinero.denegado b,
					SUPERUSUARIO.USUARIOs US,
...
<tr>
	<td colspan="13" height="50" align="center" valign="bottom" class="texto4" scope="col">Administracion de Cedulas U.I.F.</td>
</tr>
<!--<tr>
  ...
  <tr valign="bottom" class="td8" >
   ...
   <tr>
    <tr valign="bottom" class="td8" >
     ...
     <td     width="25" align="center" class="td2">Filtros:</td>
     <td width="62" align="right" valign="middle" class="td2"  scope="col">Fecha Cedula</td>      
    <!-- <td width="153"  valign="middle" class="td2" scope="col" align="left"><?php//  abrir_calendario('fechaced','premio', $fechaced);?></td>-->
     <td width="153"  valign="middle" class="td2" scope="col" align="left"><?php armar_combo_ejecutar_ninguno_ajax_get_puntero_nada($rs_feced,'fecha_cedula',$fecha_cedula,'vto','denegado/vto.php');?></td>
     <!--<td width="153"  valign="middle" class="td2" scope="col" align="left"><?php// armar_combo($rs_feced,'fecha_cedula',$fecha_cedula);?></td>-->
     
     <td width="59" align="right" valign="middle" class="td2"  scope="col">Fecha Vto.</td>      
    <!-- <td width="147"  valign="middle" class="td2" scope="col" align="left"><?php//  abrir_calendario('fechavto','premio', $fechavto);?></td> 
     ...
     <td width="20" align="center" class="td2" ><a href="#" onClick="ajax_get('contenido','denegado/agregar_denegado.php','fecha=<?php echo $fecha;?>&fecha_cedula=<?php echo $fecha_cedula;?>&fecha_vto=<?php echo $fecha_vto;?>','Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/24px-Crystal_Clear_action_db_add.png" title="Agregar Cedula" width="20" height="20" border="0"/></a></td>
     ...
     <td width="26" align="center" class="td2"><a href="#" onclick="ajax_get('contenido','denegado/adm_denegado_eliminado.php','fecha=<?php echo $fecha;?>'); return false;"><img src="image/Error.png" border="0" title="Cedulas Eliminadas" width="20" height="20" /></a></td>
     <td width="21" align="center" class="td2" ><a href="#" onClick="window.open('list1/mov_detalle_denegado.php?docu='+novedad.docu.value+'&fechita=<?php echo $fecha;?>&sexo='+novedad.sexo.value+'&fecha_cedula=<?php echo $fecha_cedula;?>&fecha_vto=<?php echo $fecha_vto;?>','Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/printer.png" title="Ver Reporte" width="20" height="20" border="0" /></a></td>
