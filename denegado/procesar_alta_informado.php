...
if(empty($_REQUEST['docu']) || !is_numeric($_REQUEST['docu']))//docu viene vacio o no es numerico
		{
			...
			<?php 
				...
				echo"<br>";
				//$_REQUEST['oculto']=0;
				//echo '<a href="#" onClick="ajax_get(\'contenido\',\'denegado/agregar_informado.php\',\'fecha='.$_REQUEST['fecha'].'&docu='.$docu.'&apenom='.$apenom.'&novedad='.$novedad.'&sexo='.$sexo.'\')"> Retornar</a><br>';
				echo '<a href="#" onClick="ajax_get(\'contenido\',\'denegado/adm_informado.php\',\'fecha='.$_REQUEST['fecha'].'\')"> Retornar</a><br>';
				exit();
				?>
				</td>
				</tr>
