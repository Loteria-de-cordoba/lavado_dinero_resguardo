...
<form id="novedad" name="novedad" action="#" onsubmit="ajax_post('contenido','alerta/adm_alerta.php',this); return false;">
  <table width="63%"  align="center">
    <tr>
      <td colspan="13" height="25" align="center" valign="bottom" class="texto4" scope="col">MATRIZ de RIESGO - ADMINISTRACION de ALERTAS</td>
    </tr>
    ...
    <tr valign="bottom" class="td8" >
      ...
      <td width="142"  valign="middle" class="td2" scope="col" align="left"><?php armar_combo_todos($rs_tipo_alerta,'tipo',$tipo);?></td>
           <td width="123" align="right" valign="middle" class="td2"  scope="col">Estado de Alerta:</td>
      <td width="107"  valign="middle" class="td2" scope="col" align="left"><?php armar_combo_todos($rs_estado_alerta,'id_estado',$id_estado);?></td>
     <td width="50"  align="center" class="td2" scope="col"><a href="#" onClick="ajax_get('contenido','alerta/adm_tipo_alerta.php','fecha=<?php echo $fecha;?>')"><img src="image/alerta.png" TITLE="Administracion de Tipos de Alertas" width="28" height="28" border="0" /></a></td>
      ...
      <td width="100" align="center" class="td2" >
