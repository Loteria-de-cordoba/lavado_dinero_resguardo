...
$titulo = "MATRIZ DE RIESGOS - Evolucion Anual de Operaciones Sospechosas al ".$_REQUEST['fecha'];
?>
<html>
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Periodo', 'Incremento Anual', 'Ocurrencia Anual'],
          <?php
				 	...
				 	$cuenta=$cuenta+1;
					   //echo $registro;
							if($cuenta==1)
									...
									{
										$incremento=$row_totales->ROS-$registro;
									}
					$tmp_a[$row_totales->ANO][$row_totales->ANO]= $row_totales->ANO;
					$tmp_a[$row_totales->ANO]['PERIODO']= $row_totales->ANO;
					$registro=$row_totales->ROS;
				 	//$yy=$row_totales->OCURRENCIA;
					//$tmp_a[$row_totales->OCURRENCIA]['OCURRENCIA']= $row_totales->OCURRENCIA;
					$tmp_a[$row_totales->ANO]['ROS']= $incremento;
					$tmp_a[$row_totales->ANO]['OCU']= $row_totales->ROS;
        ...
        var options = {
          title: 'MATRIZ DE RIESGOS - Evolucion Anual de Operaciones Sospechosas'
        };
		...
		if($rs_resumen->RowCount() > 0){
			...
			while ($row_totales = $rs_resumen->FetchNextObject($toupper=true))
				 { 
					...
					$tmp_a[$row_totales->ANO][$row_totales->ANO]= $row_totales->ANO;
					$tmp_a[$row_totales->ANO]['PERIODO']= $incremento;
					$registro=$row_rec->ROS;
				 	//$yy=$row_totales->OCURRENCIA;
					//$tmp_a[$row_totales->OCURRENCIA]['OCURRENCIA']= $row_totales->OCURRENCIA;
