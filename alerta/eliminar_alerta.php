...
-->
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="ajax_post('contenido','alerta/alerta_eliminar_grabar.php',this); return false;">
...
<table width="62%" height="53"  border="2" align="center">
	...
	<tr>
        ...
        <td align="center"  colspan="2"  style="background-color:#999966">ELIMINACION DE TIPO DE ALERTA</td>
    </tr>
