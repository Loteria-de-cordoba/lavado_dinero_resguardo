...
?>
<div  id="adjuntar"> 
  <iframe align="center" width="80%"   src="upload/upload_resguardo.php?id_tabla=<?php echo $_GET['ganador']; ?>&esquema=<?php echo $_GET['esquema']; ?>&tabla=<?php echo $_GET['tabla']; ?>&condicion=<?php echo $condicion;?>" frameborder="0"></iframe>
</div>
<div align="center">
