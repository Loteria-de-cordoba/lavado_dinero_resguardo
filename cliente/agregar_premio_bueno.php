    	...
    	<td align="left" class="texto6" scope="row">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td colspan="5" align="left" class="td_detalle"><span class="smallVerde">Nro. Documento</span><span class="smallRojo">:
                  <!--<input name="documento" type="text" id="documento" class="small" size="13" maxlength="13" value="<?php //echo $documento;?>"  onchange="ajax_get('docudocu','cliente/controla_docu.php','casino=<?php// echo $casino?>&documento='+this.value+'&tipo='+form1.id_tipo_documento.value); form1.apellido.focus();"/>-->
                  <input name="documento" type="text" id="documento" class="small" size="13" maxlength="13" value="<?php echo $documento;?>"  onchange="ajax_get('docudocu','cliente/controla_docu.php','casino=<?php echo $casino?>&documento='+this.value+'&tipo='+form1.id_tipo_documento.value+'&fecha_inicio=<?php echo $fecha_inicio;?>&fhasta=<?php echo $fhasta;?>'); form1.apellido.focus();"/>
              </span>
              <div id="docudocu">&nbsp;</div></td>
              </tr>
                <tr>
              <td align="left" class="smallVerde" scope="row">Apellido/Apodo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td class="td_detalle"><input name="apellido" type="text" class="small" id="apellido" size="50" maxlength="50" value="<?php echo $apellido;?>" /></td>
