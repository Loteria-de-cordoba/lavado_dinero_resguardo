...
try {
			$rs_cliente = $db ->Execute("select a.id_cliente as codigo, initcap(a.apellido) || ', ' || initcap(a.nombre) || ' Reg. en ' || DECODE(b.n_casino,null,'Delegacion',initcap(b.n_casino))
										 as descripcion from lavado_dinero.t_cliente a,
										 casino.t_casinos b
...
<!--  <td width="2" align="right" class="smallVerde" scope="row">&nbsp;</td>-->
            ...
            <tr><td>&nbsp;</td></tr>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
       			<tr>
               	  	<td align="center" class="textoAzulOscuroFondo" colspan="8">
                 	Datos Auxiliares
              		</td>
                   </tr>
                   <tr>
               	  	<td align="center" class="smallVerde" colspan="8">&nbsp;
                  ...
                  <td width="10%" align="right" class="smallVerde" scope="row">&nbsp;</td>
                    <td width="13%" align="right" class="smallVerde" scope="row">Fichas Ingresa</td>
                    <td width="13%" class="td_detalle"><input name="mficing" class="small_text" type="text" id="mficing" size="14" maxlength="14" onchange="if(this.value<0) {alert('El Monto debe ser superior a 0');return true;}"/></td>
                    <td width="13%" align="right" class="smallVerde" scope="row">Fichas Retira</td>
                    <td width="13%" class="td_detalle"><input name="mficret" class="small_text" type="text" id="mficret" size="14" maxlength="14" onchange="if(this.value<0) {alert('El Monto debe ser superior a 0');return true;}"/></td>
          			<td width="13%" align="right" class="smallVerde" scope="row">Perdio</td>
                    <td width="13%" class="td_detalle"><input name="monper" class="small_text" type="text" id="monper" size="14" maxlength="14" onchange="if(this.value<0) {alert('El Monto debe ser superior a 0');return true;}"/></td>
                      <td width="10%" align="right" class="smallVerde" scope="row">&nbsp;</td>
                    </tr>
                    <tr>
                    <td width="17%" align="right" class="smallVerde" colspan="2">Observaciones</td>
                    <td width="73%" class="td_detalle" colspan="5"><input name="observamov" class="small" type="text" id="observamov" size="116" maxlength="116"/></td>
                      <td width="10%" align="right" class="smallVerde" scope="row">&nbsp;</td>
