...
<tr>
	<td colspan="8" align="center" valign="bottom" class="texto4" scope="col">Administraci&oacute;n de Movimientos  - <?php echo $soydeaca;?> </a></td>
	<?php if($_SESSION['rol1']=='ROL_LAVADO_DINERO_ADMINISTRA')
	{?>
    	<td colspan="2" align="center" valign="bottom" class="texto4" scope="col"><img src="image/muchos.jpg" alt="Consulta Masiva" width="40" height="40" border="0" onclick="ajax_get('contenido','cliente/movi_masivo.php','');return false"/></td>
	<?PHP }?>
</tr>
...
<table width="95%" border="0" align="center"> 
    ...
    <?php if($casino==0)
			{?>
           <td width="10%" class="td4" scope="col">Origen Mov.</td>
           <?php }?> 
          <td width="10%" class="td4" scope="col">Fec.Movim.</td>
    <td width="22%" class="td4" scope="col">Apellido y Nombre / Apodo</td>
    <td width="27%" class="td4" scope="col">Inscripto en</td>
    <td class="td4" scope="col" colspan="2">Movimientos Registrados<br />
      Fichaje&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aciertos</td>
      <td width="7%" class="td4" scope="col">Ver Detalles</td>
   <!-- <td width="5%" class="td4" scope="col">Confirmar</td>
    ...
    <td width="7%" class="td4" scope="col">Movim.del<br />
      Apostad. </td>
    <!--<td width="7%" class="td4" scope="col">Observaci&oacute;n</td>    -->    
	   ...
	   <tr class="<?php if ($_pagi_result->CurrentRow()%2) { echo "td";}  else {echo "td8";}?>">
           <?php if($casino==0)
			...
			{?>
           <td width="10%" ><?php echo $row->CASINOORIGEN;
           ...
           <td width="14%" align="right"><?php echo number_format($row->FICHAJE,2,',','.');?></td>
...
<?php if($row->ID_NOVEDAD==NULL)
	 ...
	 <?php 
		...
		?>
         ...
         <td width="7%" align="center" ><a href="#" onClick="window.open('list1/mov_apostadores.php?id_cliente=<?php echo $row->ID_CLIENTE ?>&casino=<?php echo $row->CASINOPASA;?>&fechita=<?php echo $row->FECHA;?>','Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/printer.png" alt="Ver Reporte" width="20" height="20" border="0" /></a></td>
  </tr>
