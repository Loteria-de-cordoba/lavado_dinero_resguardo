...
<tr>
	<td colspan="8" align="center" valign="bottom" class="texto4" scope="col">Administraci&oacute;n de Movimientos  - <?php echo $soydeaca;?>[Datos Resguardados]  </a></td>
	<?php if($_SESSION['rol1']=='ROL_LAVADO_DINERO_ADMINISTRA')
	{?>
    	<td colspan="4" align="center" valign="bottom" class="texto4" scope="col"><img src="image/muchos.jpg" alt="Consulta Masiva" width="40" height="40" border="0" onclick="ajax_get('contenido','cliente/movi_masivo.php','');return false"/></td>
	<?PHP }?>
</tr>
...
<?php if($apostador<>'')
		 {?>   
         <td width="142"  valign="middle" class="td2" scope="col" align="center"><div id="casinito"><?php armar_combo_todos($rs_apostador,"apostador",$apostador);?></div></td>  
<?php }?>
      ...
      <?php if ($_SESSION['rol'.$j]!='ROL_LAVADO_DINERO_ADM_CASINO') {?>
   	 <?php }?>
     <!--<td width="24" align="center" class="td2" ><a href="#" onClick="ajax_get('contenido','cliente/agregar_movimiento.php','apostador='+premio.apostador.value+'&casino='+premio.casino.value+'&novedad=<?php// echo '1'?>','Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/24px-Crystal_Clear_action_db_add.png" alt="Agregar Movimiento" width="20" height="20" border="0"/></a></td>-->
	                <td width="21" align="center" class="td2" ><a href="#" onClick="window.open('list1/mov_apostadores_todos.php?apostador=<?php echo $apostador ?>&casino='+premio.casino.value+'&fecha='+premio.fecha.value+'&fhasta='+premio.fhasta.value,'Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/printer.png" alt="Ver Reporte" width="20" height="20" border="0" /></a></td>
      <!--<td align="center" class="td2" scope="col" ><a href="#" onclick="window.open('list1/datos_apostadores_todos.php?casino='+premio.casino.value+'&fecha='+premio.fecha.value+'&fhasta='+premio.fhasta.value,'Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/printer.png" alt="Ver Reporte" width="20" height="20" border="0" /></a></td>-->
      <td width="24" align="center" class="td2"><img width="24" height="24" onclick="window.open('cliente/lista_apostadores_xls.php?apostador=<?php echo $apostador ?>&casino='+premio.casino.value+'&fecha='+premio.fecha.value+'&fhasta='+premio.fhasta.value)" title="REPORTE EXCEL" src="image/Excel-Document.png" border="0" complete="complete" ;=""/></td>
...
<table width="95%" border="0" align="center"> 
  ...
  <?php }?> 
    ...
    <td width="15%" class="td4" scope="col" rowspan="2">Inscripto en</td>
    <td class="td4" scope="col" colspan="4">Movimientos Registrados</td>
    <td width="4%" class="td4" scope="col" rowspan="2">Ver Detalles</td>
  ...
  <?php }
       ...
       <?php }}?>
           ...
           <td width="6%" align="left"><?php echo utf8_decode($row->CASINO);?></td>
         <td width="6%" align="right"><?php echo number_format($row->FICHAJE,2,',','.');?></td>
         <td width="14%" align="right"><?php echo number_format($row->ACIERTO,2,',','.');?></td>
         <td width="17%" align="right"><?php echo number_format($row->INGRESO,2,',','.');?></td>
