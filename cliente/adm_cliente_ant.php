...
$_pagi_sql ="select a.id_cliente, to_char(a.fecha_alta,'DD/MM/YYYY') as fecha, initcap(a.nombre) nombre , initcap(a.apellido) apellido,a.domicilio as domicilio, 
						b.n_casino as casa,   a.id_casino,  a.observacion as observacion
...
<tr>
	<td colspan="9
    " align="center" valign="bottom" class="texto4" scope="col">Administraci&oacute;n de Apostadores </a></td>
</tr>
...
<table width="95%" border="0" align="center"> 
    ...
    <td width="26%" class="td4" scope="col">Apellido y Nombre</td>
    <td width="20%" class="td4" scope="col">Inscripto en</td>
    <td width="20%" class="td4" scope="col">Domicilio</td>
    <td width="6%" class="td4" scope="col">Modificar</td>
    ...
    <td width="7%" class="td4" scope="col">Observaci&oacute;n</td>        
	   ...
	   <tr class="<?php if ($_pagi_result->CurrentRow()%2) { echo "td";}  else {echo "td8";}?>">
           ...
           <td align="left"><?php echo utf8_decode($row->DOMICILIO);?></td>
            <td align="center" ><a href="#" onclick="ajax_get('contenido','cliente/modificar_apostador.php','id_cliente=<?php echo $row->ID_CLIENTE ?>&casino=<?php echo $casino;?>&fecha_inicio=<?php echo $fecha ?>&fhasta=<?php echo $fhasta ?>'); return false;" ><img src="image/modificar.png" alt="modificar datos"  width="20" height="20" border="0"/></a></td>       
       <!--<td align="center" ><a href="#" onClick="ajax_get('contenido','cliente/cliente_eliminar_grabar.php','id_cliente=<?php echo $row->ID_CLIENTE;?>&casino=<?php echo $casino ; ?>'); return false;">
								<img src="image/roseta_ok.png" alt="Activa" width="20" height="20" border="0" /></a></td>-->
                                     <td align="center" ><a href="#" onClick="ajax_get('elimina','cliente/controla_eliminacion.php','id_cliente=<?php echo $row->ID_CLIENTE;?>&casino=<?php echo $casino;?>&apellido=<?php echo $row->APELLIDO;?>&nombre=<?php echo $row->NOMBRE;?>&fecha_inicio=<?php echo $fecha ?>&fhasta=<?php echo $fhasta ?>');return false;"><img src="image/roseta_ok.png" alt="Elimina" width="20" height="20" border="0"/></a></td>
