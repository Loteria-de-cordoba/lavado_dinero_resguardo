     ...
     <td width="28%"   class="td4" scope="col">Apellido y Nombre / Apodo</td>
      ...
      <td width="5%"  class="td4" scope="col">Anular</td>
	   ...
	   <tr class="<?php if ($_pagi_result->CurrentRow()%2) { echo "td";}  else {echo "td8";}?>">
		   ...
		   {?>
            <td align="center"><a href="#" onclick="ajax_get('contenido','cliente/modificar_novedad.php','id_id=<?php echo $row->IDID;?>&casino=<?php echo $casino;?>&fecha=<?php echo $fecha;?>');return false;"><img src="image/modificar.png" alt="Modifica este Movimiento?" width="20" height="20" border="0"/></a></td>
           <td align="center"><a href="#" onclick="ajax_get('elimina','cliente/controla_eliminacion_novedad_casino.php','id_id=<?php echo $row->IDID;?>&casino=<?php echo $casino;?>&fecha=<?php echo $fecha;?>');return false;"><img src="image/roseta_ok.png" alt="Anula este Movimiento?" width="20" height="20" border="0"/></a></td>
           <?PHP }
		   else
		   {?>
		   	 <td width="2%" align="center" colspan="2"><img src="image/candado.png" alt="Imposible - Jornada Cerrada" width="20" height="20" border="0"/></td>
		   <?php }
		   ?>
  </tr>
