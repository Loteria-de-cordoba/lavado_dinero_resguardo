...
-->
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="ajax_post('contenido','cliente/procesar_alta_novedad.php',this); return false;">
 	<?php if(!isset($_GET['cantidad']))
	{?>
    <table width="47%" height="53"  border="2" align="center" style="background-color:#999966">
      <tr>
                    
                    <td width="1005" align="center"  colspan="2"><marquee><?php echo $soydelcasino;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha Contable:<?php echo $fecha;?></marquee><div align="right"><img src="image/24px-Crystal_Clear_action_reload.png" alt="Regresar" width="16" height="16" border="0" align="absbottom" /> <a href="#"  onclick="ajax_get('contenido','cliente/adm_novedad_casino.php','casino=<?php echo $casino?>&fecha=<?php echo $fecha ?>')">Regresar</a></div></td>
                  </tr>
      <tr>
