...
<!--                    <td align="center" class="small_derecha" scope="col">
                ...
                <tr>
              <td align="left" class="smallVerde" scope="row">Apellido/Apodo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td class="td_detalle"><input name="apellido" type="text" class="small" id="apellido" size="50" maxlength="50" value="<?php echo utf8_encode($row_modifica->APELLIDO);?>" disabled="disabled" /></td>
