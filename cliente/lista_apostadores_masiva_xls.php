...
<table width="95%"  align="center">
    <tr>
        <td colspan="12" align="center" valign="bottom" class="texto4" scope="col">Consulta Masiva de Movimientos  - <?php echo $soydeaca;?> </a> - [Datos Resguardados]</td>
  </tr>
</table>
<table width="95%" border="0" align="center">    
  ...
  <?php //}
       ...
       <?php //}
         ...
         <td width="20%" align="right"><?php echo number_format($row->ACIERTO,2,',','.');?></td>
         <td width="13%" align="right"><?php echo number_format($row->INGRESO,2,',','.');?></td>
...
<?PHP    }?>
		...
		<tr>
          ...
          <td  align="right" valign="bottom" class="texto4" scope="col"><?php echo number_format($totperdido,2,',','.');?></td>
