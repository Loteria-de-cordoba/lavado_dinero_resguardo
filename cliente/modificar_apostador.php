...
try {
	$r_modifica=$db->Execute("select   id_tipo_documento,
						   documento,
						   decode (nombre, NULL,Initcap(apellido), Initcap(apellido) || ', ' ||  Initcap(nombre)) as apellido,
						   nombre,
							nacionalidad, 
							domicilio,
							profesion,
...
$row_modifica= $r_modifica->FetchNextObject($toupper=true);
//echo $row_modifica->ID_TIPO_DOCUMENTO;
//die();
//echo $row_modifica->APELLIDO;
//die();
try {
...
-->
  ...
  <form name="form1" id="form1" method="post" action="#" onSubmit="ajax_post('contenido','cliente/procesar_modificar_apostador.php',this); return false;">
...
<!--                    <td align="center" class="small_derecha" scope="col">
                    <a href="#" onclick="ajax_get('contenido','cliente/modificar_apostador.php','id_cliente=<?php// echo $id_cliente;?>&casino=<?php// echo $casino;?>'); return false;"><img src="image/24px-Crystal_Clear_action_filenew.png" border="0" alt="Alta de datos personales" width="16" height="16" />  Blanquear Formulario</a></td>-->
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="center" class="textoAzulOscuroFondo" scope="col">MODIFIQUE DATOS  DEL APOSTADOR</td>
    ...
    <?php }?>
			  ...
			  {?>
              <td class="td_detalle" colspan="3"><input name="apellido" type="text" class="small" id="apellido" size="100" maxlength="100" value="<?php echo utf8_encode($row_modifica->APELLIDO);?>" disabled="disabled" /></td>
              <?php }
			  else
			  {?>
			  <td class="td_detalle" colspan="3"><input name="apellido" type="text" class="small" id="apellido" size="100" maxlength="100" value="<?php echo utf8_encode($_GET['apellido']);?>" disabled="disabled" /></td>
             
			 <?php  }?>
              
              <!--<td colspan="3" class="smallVerde" >Nombre:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="nombre" type="text" class="small" id="nombre" size="50" maxlength="50" value="<?php //echo utf8_encode($row_modifica->NOMBRE);?>" disabled="disabled" /></td>
              ...
              <td class="td_detalle">&nbsp;</td>-->
                        ...
                        <tr>
                          ...
                          <td width="27%" align="left" class="smallVerde"><?php  abrir_calendario('fecha','nacimiento', $row_modifica->FECHA_ALTA);?>                          </td>
                          <td width="10%" align="left" class="smallVerde">Domicilio:</td>
                          <td colspan="2" align="left" class="smallVerde">
                          <input name="lugar_nacimiento" type="text" class="small" id="lugar_nacimiento" size="50" maxlength="50" value="<?php echo utf8_encode($row_modifica->DOMICILIO);?>"/>                          </td>
                          <td width="3%" class="smallVerde" align="right">Sexo:</td>
                          <td width="14%" class="texto5">
                          <?PHP //echo substr($row_modifica->SEXO,0,1);
						  if(substr($row_modifica->SEXO,0,1)=="M" or substr($row_modifica->SEXO,0,1)=="m") {
						  //echo "paso";?>
               ...
               <tr>
              <td width="8%" align="right" class="smallVerde" scope="row"><div align="left">Tipo de documento:</div></td>
              <td class="td_detalle"><?php echo armar_combo($rs_tipo_documento,'id_tipo_documento',utf8_encode($row_modifica->ID_TIPO_DOCUMENTO)); ?></td>
              <td colspan="5" align="left" class="td_detalle"><span class="smallVerde">Nro. Documento</span><span class="smallRojo">:
                 <?PHP if($row_modifica->DOCUMENTO<>'' and !isset($_GET['documento']))
				 {?>
                  <input name="documento" type="text" id="documento" class="small" size="13" maxlength="13" value="<?php echo $row_modifica->DOCUMENTO; ?>" disabled="disabled"   />
                  <?php }
				  else
				  {
				  ?>
                   <input name="documento" type="text" id="documento" class="small" size="13" maxlength="13" value="<?php echo $row_modifica->DOCUMENTO; ?>" onchange="ajax_get('docudocu','cliente/controla_docu.php','casino=<?php echo $casino?>&documento='+this.value+'&tipo='+form1.id_tipo_documento.value+'&id_cliente=<?php echo $row_modifica->ID_CLIENTE;?>&fecha_inicio=<?php echo $fecha_inicio;?>&fhasta=<?php echo $fhasta;?>&abm=<?php echo $abm;?>&apodo='+form1.apellido.value); form1.cuit.focus();"/>
                  <?php }?>
                 Identificacion del cliente (Tipo de documento y numero)</span>
              <div id="docudocu">&nbsp;</div></td>
              </tr>
                      <tr>
                        <td align="left" class="smallVerde" scope="row">CUIT/CUIL/CDI:&nbsp;&nbsp;</td>
                        <td colspan="4" class="smallRojo"><input name="cuit" type="text" class="small" id="cuit" size="13" maxlength="13" value="<?php echo $row_modifica->CUIT;?>" />
                          ...
                          <td width="47" align="right" valign="middle"class="smallRojo"  scope="col">Casino</td>      
      <td width="145"  valign="middle" class="smallRojo" scope="col" align="center"><?php armar_combo($rs_casino,"casino",$casino);?></td> 
                      </tr>
              ...
              <td colspan="6" align="right" class="texto5" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="11%"><span class="td_detalle">
                    <input name="nacionalidad" type="text" class="small" id="nacionalidad" value="<?php echo $row_modifica->NACIONALIDAD;?>" size="20" maxlength="20" />
                  </span></td>
                  <td width="18%">&nbsp;</td>
                  <td width="7%" align="right" class="smallVerde">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Profesion:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td width="64%" class="smallRojo" align="left"> <input name="profesion" type="text" class="small" id="profesion" size="30" maxlength="50" value="<?php echo utf8_encode($row_modifica->PROFESION);?>" />
           ...
           <!-- <td align="right" class="smallVerde" scope="row">DDJJ Nro:</td>-->
              <td colspan="9" scope="row" class="smallVerde"><!--<input name="ddjj" class="small" type="text"  id="ddjj" size="3" maxlength="4" />-->Estado civil:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="estado_civil" class="small" type="text"  id="estado_civil" size="20" maxlength="20" value="<?php echo $row_modifica->ESTADO_CIVIL;?>"/>
                <span class="smallVerde">Telefono:</span>                <input name="telefono" class="small" type="text" id="telefono" size="20" maxlength="20" value="<?php echo $row_modifica->TELEFONO;?>" />
                <span class="smallVerde">Email:
                <input name="email" class="small" type="text" id="email" size="50" maxlength="50" value="<?php echo utf8_encode($row_modifica->EMAIL);?>"/>
                </span></td></tr>
                  <tr align="left">
                  <td colspan="9" scope="row" class="smallVerde">Observacion:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="observacion" class="small" type="text" id="observacion" size="100" maxlength="100" value="<?php echo utf8_encode($row_modifica->OBSERVACION);?>"/>
              </td>
                ...
                <tr>
                  <td >
                    <div align="center">
                      <!-- <input name="button3" type="image" id="button3" src="image/folder_16.png" alt="Seleccionar provincia" width="16" height="16" onclick="if (chk_extranjero.checked) {return false;} else {ajax_showTooltip('premio/provincias_tooltip.php?jsfecha='+new Date()+'&amp;formulario='+this.form.name+'&amp;codigo='+cod_pais.value,this);  return false; }"/>-->
                       <input name="provincia" type="text" class="tdVerde" id="provincia" value="<?php echo $row_modifica->PROVINCIA;?>"/>
                  ...
                  <td>
                      <div align="center">
                        ...
                        <input name="localidad" type="text" class="tdVerde" id="localidad" value="<?php echo $row_modifica->LOCALIDAD;?>"/>
                  ...
                  <td align="center" colspan="2"><span class="texto3">
                    <input name="cod_postal" type="text" align="center" class="small" id="cod_postal" size="15" maxlength="13" value="<?php echo $row_modifica->COD_POSTAL;?>" />
    ...
    <?php //}?>-->
            <tr align="left">
              <td align="center" scope="row" colspan="8"><input name="button" type="submit" class="textoAzulOscuro" id="button" value="Modificar" /></td>
            </tr>
            <tr align="left">
