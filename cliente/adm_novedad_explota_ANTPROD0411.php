...
try {
	$rs_apostador = $db->Execute("SELECT  'Sr/a. ' || decode(cl.nombre,NULL,initcap(cl.apellido),initcap(cl.apellido) || ', ' || initcap(cl.nombre)) || decode(cl.documento,null,'',' Documento Nro. ' || cl.documento) as datos,
								...
								casino.t_casinos ca,
								lavado_dinero.t_novedades_cliente g 
	...
	die($db->ErrorMsg());
		...
		$datos1=utf8_encode($row_apostador->DATOS1);
...
<table width="99%" border="0" align="center"> 
  <tr>
	<td colspan="10" align="center" valign="bottom" class="texto4" scope="col">Movimientos Pertenecientes a <?php echo $datos.'<br>'.$datos1?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="window.open('list1/mov_apostadores_detalle.php?id_cliente=<?php echo $apostador ?>&casino=<?php echo $casino;?>&fechita=<?php echo $fechita ?>','Ventana','width=400,height=400,top=0,Left=0,menubar=no,scrollbars=yes,resizable=yes')"><img src="image/printer.png" alt="Ver Reporte" width="20" height="20" border="0" /></a></td>
