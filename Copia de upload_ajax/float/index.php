...
<a href="#" onclick="customFunctionCreateWindow('upload_ajax/index.php',500,200,400,100);return false">Create new window dynamically(get data from external file)</a>
